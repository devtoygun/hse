...
<html lang="tr">
    <head>
        ...
        <title>Sifre Yenileme Kodu</title>
    </head>
                    ...
                    <table role="presentation" width="560" cellspacing="0" cellpadding="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 6px 20px rgba(0,0,0,0.08);">
                        <tr>
                            <td style="background:#242745;color:#fff;padding:18px 22px;">
                                ...
                                <div style="opacity:0.85;font-size:12px;margin-top:4px;">Sifre yenileme kodu</div>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding:22px;">
                                <p style="margin:0 0 12px 0;color:#111827;font-size:14px;line-height:1.5;">
                                    Sifre yenileme isleminizi tamamlamak icin asagidaki 6 haneli kodu kullanin.
                                </p>

                                <div style="margin:16px 0;padding:16px;border:1px dashed #d1d5db;border-radius:12px;text-align:center;">
                                    <div style="font-size:28px;font-weight:800;letter-spacing:10px;color:#242745;">{{ $code }}</div>
                                </div>

                                <p style="margin:12px 0 0 0;color:#6b7280;font-size:12px;line-height:1.5;">
                                    Bu kod {{ $expiresMinutes }} dakika boyunca gecerlidir.
                                </p>
                            </td>
                        </tr>
                        <tr>
