    ...
    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
        ...
        <li class="nav-item navbar-dropdown dropdown-user dropdown">
            ...
            <div class="avatar avatar-online">
                <img src="../../assets/img/avatars/1.png" alt class="h-auto rounded-circle" /> {{Auth::user()->firstname.' '.Auth::user()->lastname}}
            </div>
            </a>
            <ul class="dropdown-menu dropdown-menu-end">
            <li>
                ...
                <div class="d-flex">
                    ...
                    <small class="text-muted">{{ Auth::user()->is_admin ? 'Yönetici' : 'Kullanıcı'}}</small>
                    </div>
                </div>
                </a>
            </li>
